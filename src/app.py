...
st.set_page_config(page_title="PDF Translator (Gemini AI)", layout="wide")

st.title("📄 Gemini-Powered PDF Translator")
st.markdown("Translates PDFs while preserving layout using **Google Gemini Flash**.")

# Sidebar for configuration
with st.sidebar:
    st.header("Configuration")
    api_key = st.text_input("Gemini API Key", type="password", help="Get free key from aistudio.google.com")
    ...
    st.info("Note: heavily visual PDFs work best. Processing speed depends on Gemini response.")
