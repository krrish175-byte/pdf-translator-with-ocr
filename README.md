...
A web application that translates PDF documents from English to Japanese while preserving formatting and translating text within images using OCR.

## Features

- 📄 **PDF Text Translation** - Extract and translate all text content from PDFs
- 🖼️ **OCR Image Translation** - Detect and translate English text within images  
...
```bash
sudo apt-get update
sudo apt-get install tesseract-ocr tesseract-ocr-jpn tesseract-ocr-eng poppler-utils
```
...
4. Preview the translated pages
...
- **Backend**: Flask, PyMuPDF, pytesseract, deep-translator, OpenCV
